  ...
  return (
    <section id="hero" className='relative overflow-hidden'>
        ...
        <div className='hero-layout'>
            {/*left hero content*/}
            <header className='flex flex-col justify-center w-full w-screen md:px-20 px-5'>
                <div className='flex flex-col gap-7'>
                    <div className='hero-text'>                    
                        <h1>Building web applications from
                        ...
                        <h1>that solves customer problems and delivers results. </h1>
                    </div>
